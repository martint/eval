...
@State(Scope.Thread)
public class NativeMemorySegments
{
    ...
    {
        MemorySegment result = MemorySegment.allocateNative(data.length, SegmentScope.global());
    ...
    {
        MemorySegment result = MemorySegment.allocateNative(data.length * Long.BYTES, Long.BYTES, SegmentScope.global());
        result.copyFrom(MemorySegment.ofArray(data));
        return result;
    }
    ...
    {
        MemorySegment result = MemorySegment.allocateNative(data.length * Integer.BYTES, Long.BYTES, SegmentScope.global());
        result.copyFrom(MemorySegment.ofArray(data));
        return result;
    }
